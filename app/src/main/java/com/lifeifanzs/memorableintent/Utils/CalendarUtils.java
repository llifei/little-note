...
public class CalendarUtils {
     ...
     */
    public static void addCalendarEventRemind(Context context, @NonNull String title, String description,
                                              long begintime, long endtime, int remind_minutes, onCalendarRemindListener callback) {
        ...
        try {
            ...
            if (eventCursor.getCount() > 0) {
                ...
                for (eventCursor.moveToFirst(); !eventCursor.isAfterLast(); eventCursor.moveToNext()) {
                    ...
                    System.out.println((!TextUtils.isEmpty(title) && title.equals(eventTitle) && dtstart == startTime)
                            || (title == null && eventTitle == null && dtstart == startTime));
                    if ((!TextUtils.isEmpty(title) && title.equals(eventTitle) && dtstart == startTime)
                            || (title == null && eventTitle == null && dtstart == startTime)) {
    ...
    //更新
    public static void updateEvent(Context context, Memory memory) {
//        deleteCalendarEventRemind(context, memory.getTitle(), memory.getDetail()
//                , memory.getDate().getTime(), null);
//        addCalendarEventRemind(context, memory.getTitle(), memory.getDetail(), memory.getDate()
//                .getTime(), memory.getDate().getTime() + 60000, 5, null);
    }
